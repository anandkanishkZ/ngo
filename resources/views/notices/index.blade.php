            ...
            <div class="col-lg-6">
              <div class="featured-image-container">
                <img class="featured-image" 
                     src="{{ $featuredNotice->image_url ?? 'https://images.unsplash.com/photo-1560472354-b33ff0c44a43?q=80&w=800&auto=format&fit=crop' }}" 
              ...
              <div class="notice-card profile-style-card">
                <div class="card-image-section">
                  <img class="notice-image" 
                       src="{{ $notice->image_url ?? 'https://images.unsplash.com/photo-1560472354-b33ff0c44a43?q=80&w=600&auto=format&fit=crop' }}" 
                       alt="{{ $notice->title }}">

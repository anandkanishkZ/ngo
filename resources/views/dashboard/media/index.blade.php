  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="uploadForm" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="folder" placeholder="e.g., hero-images, event-photos" onclick="console.log('Folder input clicked')">
            <div class="form-text">Leave empty to upload to root folder</div>
          </div>
          
          <div class="mb-3">
            <div class="upload-zone" id="uploadZone" onclick="console.log('Upload zone clicked')">
              <div class="upload-zone-content">
                <i class="fa-solid fa-cloud-upload fa-3x text-primary mb-3"></i>
                <h5>Drag & Drop Files Here</h5>
                <p class="text-muted">or <button type="button" class="btn btn-link p-0" id="browseFilesBtn" onclick="console.log('Browse button clicked')">browse files</button></p>
                <input type="file" id="fileInput" name="files[]" multiple class="d-none" accept="image/*,application/pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx,.zip,.rar,.txt,.csv" onchange="console.log('File input changed')">
              </div>
            </div>
          </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" onclick="console.log('Cancel clicked')">Cancel</button>
        <button type="button" class="btn btn-primary" id="uploadSubmit" disabled onclick="console.log('Upload clicked')">Upload Files</button>
      </div>
    </div>
  </div>
</div>
...
/* ============================================
   MODAL FIX - CRITICAL FOR CLICKABILITY
   ============================================ */

/* Step 1: Set correct z-index hierarchy */
.modal-backdrop {
...
/* Step 2: Modal dialog - allow backdrop clicks but NOT content clicks */
.modal-dialog {
  position: relative;
  margin: 1.75rem auto;
  /* DO NOT SET pointer-events: none here! Let Bootstrap handle it */
}

/* Step 3: Make modal content fully interactive */
.modal-content {
  position: relative;
...
/* Step 4: Ensure all interactive elements work */
.modal-header,
.modal-body,
.modal-footer {
  pointer-events: auto !important;
...
/* Step 5: Upload zone must be clickable */
.upload-zone {
  pointer-events: auto !important;
  position: relative;
  z-index: 1;
...
/* Step 6: Remove layout interference */
body.modal-open {
  overflow: hidden;
...
/* Step 7: Force proper stacking context */
.modal.show {
...
document.addEventListener('DOMContentLoaded', function() {
  console.log('Media Library: DOM Content Loaded');
  loadStats();
  initializeEventListeners();
  
  // Emergency test: Add visible test button to verify clicks work
  const testBtn = document.createElement('button');
  testBtn.innerHTML = 'TEST CLICK';
  testBtn.className = 'btn btn-danger btn-sm';
  testBtn.style.cssText = 'position: fixed; top: 80px; right: 20px; z-index: 99999;';
  testBtn.onclick = function() {
    alert('Button clicked! Clicks are working on the page.');
...
function showUploadModal() {
  ...
  // Create and show modal with proper Bootstrap initialization
  ...
  console.log('Modal instance created and shown');
}

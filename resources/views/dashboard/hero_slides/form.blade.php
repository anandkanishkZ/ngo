...
<div class="row g-4">
        ...
        <div class="row g-4">
          <div class="col-12">
            ...
            <input type="text" name="title" value="{{ old('title', $slide->title ?? '') }}" 
                   class="form-control form-control-lg" placeholder="Enter compelling hero title..." required>
          ...
          <div class="col-md-8">
            <div class="upload-area border-2 border-dashed rounded-3 p-4 text-center position-relative">
              <input type="file" name="bg_image" id="bgImageInput" 
                     class="form-control opacity-0 position-absolute w-100 h-100" 
            ...
            <div id="bgImagePreview" class="mt-3">
              @if(isset($slide))
                ...
                @elseif($slide->bg_image)
                  <div class="current-image-preview border rounded-3 p-3 bg-light">
                    <div class="d-flex align-items-center">
                      <img src="{{ asset('storage/' . $slide->bg_image) }}" alt="Background" 
                           class="rounded-2 me-3" style="width: 60px; height: 60px; object-fit: cover;">
                      <div>
            ...
            <div class="border rounded-3 p-3 bg-light">
              ...
              <div class="mb-3">
                ...
                <input type="text" name="button1_text" value="{{ old('button1_text',$slide->button1_text ?? '') }}" 
                       class="form-control" placeholder="Get Started">
              </div>
              <div class="mb-3">
              ...
              <div class="mb-0">
                ...
                <select name="button1_style" class="form-select">
            ...
            <div class="border rounded-3 p-3 bg-light">
              ...
              <div class="mb-3">
                ...
                <input type="text" name="button2_text" value="{{ old('button2_text',$slide->button2_text ?? '') }}" 
                       class="form-control" placeholder="Learn More">
              </div>
              <div class="mb-3">
                <label class="form-label fw-semibold">Button URL</label>
              ...
              <div class="mb-0">
                <label class="form-label fw-semibold">Button Style</label>
                <select name="button2_style" class="form-select">
  ...
  <div class="col-lg-4 order-2 order-lg-2">
          ...
          <div class="col-6">
            ...
            <div class="input-group input-group-sm">
              <input type="text" name="title_size" value="{{ old('title_size',$slide->title_size ?? '3.5rem') }}" 
                     class="form-control" placeholder="3.5rem">
          ...
          <div class="col-6">
            ...
            <div class="input-group input-group-sm">
              <input type="text" name="subtitle_size" value="{{ old('subtitle_size',$slide->subtitle_size ?? '1.25rem') }}" 
                     class="form-control" placeholder="1.25rem">
              <span class="input-group-text bg-light">rem</span>
            </div>
              ...
              <div class="input-group input-group-sm">
                <span class="input-group-text p-1">
                  <input type="color" name="title_color" value="{{ old('title_color',$slide->title_color ?? '#ffffff') }}" 
                         class="form-control-color border-0" style="width: 30px; height: 30px; border-radius: 4px;">
                </span>
                <input type="text" class="form-control color-value" value="{{ old('title_color',$slide->title_color ?? '#ffffff') }}" readonly>
              </div>
            </div>
          </div>
          <div class="col-6">
            ...
            <div class="color-picker-wrapper">
              <div class="input-group input-group-sm">
                ...
                <input type="text" class="form-control color-value" value="{{ old('subtitle_color',$slide->subtitle_color ?? '#ffffff') }}" readonly>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row g-3">
          <div class="col-12">
            ...
            <div class="btn-group d-flex" role="group">
              ...
              <input type="radio" class="btn-check" name="text_position" id="pos-left" value="left" {{ $pos==='left'?'checked':'' }}>
              <label class="btn btn-outline-primary btn-sm" for="pos-left">
                <i class="fas fa-align-left"></i> Left
              </label>
              
              <input type="radio" class="btn-check" name="text_position" id="pos-center" value="center" {{ $pos==='center'?'checked':'' }}>
              <label class="btn btn-outline-primary btn-sm" for="pos-center">
                <i class="fas fa-align-center"></i> Center
              </label>
              
              <input type="radio" class="btn-check" name="text_position" id="pos-right" value="right" {{ $pos==='right'?'checked':'' }}>
          ...
          <div class="col-12">
            ...
            <div class="btn-group d-flex" role="group">
              ...
              <input type="radio" class="btn-check" name="vertical_position" id="vpos-top" value="top" {{ $vpos==='top'?'checked':'' }}>
              <label class="btn btn-outline-success btn-sm" for="vpos-top">
                <i class="fas fa-arrow-up"></i> Top
              </label>
              
              <input type="radio" class="btn-check" name="vertical_position" id="vpos-middle" value="middle" {{ $vpos==='middle'?'checked':'' }}>
              <label class="btn btn-outline-success btn-sm" for="vpos-middle">
                <i class="fas fa-minus"></i> Middle
              </label>
              
              <input type="radio" class="btn-check" name="vertical_position" id="vpos-bottom" value="bottom" {{ $vpos==='bottom'?'checked':'' }}>
        ...
        <div class="row g-3">
          ...
          <div class="col-12">
            ...
            <div class="position-relative">
              <select name="animation_duration" class="form-select form-select-sm">
          ...
          <div class="col-12">
            <div class="bg-light rounded p-3">
              <div class="form-check form-switch">
                <input class="form-check-input" type="checkbox" name="overlay_enabled" id="overlay_toggle"
    ...
    <div class="card border-0 shadow-sm">
      <div class="card-header bg-gradient" style="background: linear-gradient(135deg, #ff9a9e 0%, #fecfef 100%); color: #8b008b;">
        <h6 class="card-title mb-0 d-flex align-items-center">
          <i class="fas fa-eye me-2"></i>Status & Visibility
        </h6>
      </div>
      <div class="card-body p-4">
        <div class="bg-light rounded p-3 mb-3">
          <div class="form-check form-switch">
            <input class="form-check-input" type="checkbox" name="is_active" id="active_toggle"
                   {{ old('is_active', $slide->is_active ?? true) ? 'checked' : '' }}>
            <label class="form-check-label fw-semibold" for="active_toggle">
              <span class="status-indicator">
                <i class="fas fa-circle text-success me-2"></i>Active Slide
              </span>
            </label>
          </div>
          <small class="text-muted d-block mt-1">
            Only active slides are displayed on the website homepage
          </small>
        </div>
        
        <div class="mb-3">
          <label class="form-label fw-bold text-muted small text-uppercase">Display Order</label>
          <div class="input-group input-group-sm">
            <span class="input-group-text bg-light">
              <i class="fas fa-sort-numeric-down"></i>
            </span>
            <input type="number" name="position" value="{{ old('position', $slide->position ?? 1) }}" 
                   class="form-control" min="1" max="100" placeholder="1">
            <span class="input-group-text bg-light">/100</span>
          </div>
          <small class="text-muted d-block mt-1">
            <i class="fas fa-info-circle me-1"></i>Lower numbers appear first in the slideshow
          </small>
        </div>

        @if(isset($slide) && $slide->id)
        <div class="border rounded p-3" style="background: linear-gradient(135deg, #e3f2fd 0%, #f3e5f5 100%);">
          <h6 class="mb-2 text-primary">
            <i class="fas fa-info-circle me-2"></i>Slide Information
          </h6>
          <div class="small text-muted">
            <div class="d-flex justify-content-between mb-1">
              <span><i class="fas fa-calendar-plus me-1"></i><strong>Created:</strong></span>
              <span>{{ $slide->created_at->format('M j, Y g:i A') }}</span>
            </div>
            <div class="d-flex justify-content-between mb-1">
              <span><i class="fas fa-calendar-edit me-1"></i><strong>Updated:</strong></span>
              <span>{{ $slide->updated_at->format('M j, Y g:i A') }}</span>
            </div>
            <div class="d-flex justify-content-between">
              <span><i class="fas fa-hashtag me-1"></i><strong>Slide ID:</strong></span>
              <span class="badge bg-primary">#{{ $slide->id }}</span>
            </div>
          </div>
        </div>
        @endif

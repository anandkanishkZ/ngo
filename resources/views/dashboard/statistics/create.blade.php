  ...
  <div class="row g-3">
    <div class="col-12">
      <div class="d-flex align-items-center gap-2 mb-3">
        ...
        <div>
          <h4 class="mb-1"><i class="fa-solid fa-plus me-2"></i>Create New Statistic</h4>
          <p class="text-muted mb-0">Add a new statistic counter to your homepage</p>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-8">
      <div class="ds-card p-4">
        <form method="POST" action="{{ route('dashboard.statistics.store') }}">
          @csrf
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <input type="text" name="key" value="{{ old('key') }}" class="form-control @error('key') is-invalid @enderror" 
            ...
            <div class="col-md-6">
              ...
              <input type="number" name="value" value="{{ old('value', 0) }}" class="form-control @error('value') is-invalid @enderror" 
                     min="0" required>
            ...
            <div class="col-md-6">
              ...
              <div class="input-group">
                <span class="input-group-text">
                  <i id="iconPreview" class="{{ old('icon', 'fa-solid fa-chart-line') }}"></i>
                </span>
            ...
            <div class="col-md-6">
              ...
              <div class="input-group">
                <input type="color" name="color" value="{{ old('color', '#f39c12') }}" class="form-control form-control-color @error('color') is-invalid @enderror" 
                       onchange="document.getElementById('colorText').value = this.value">
                <input type="text" id="colorText" value="{{ old('color', '#f39c12') }}" class="form-control" 
            ...
            <div class="col-12">
              ...
              <textarea name="description" rows="3" class="form-control @error('description') is-invalid @enderror" 
                        placeholder="Internal note about this statistic...">{{ old('description') }}</textarea>
          ...
          <div class="d-flex gap-2 mt-4">
            <button type="submit" class="btn btn-primary">
              <i class="fa-solid fa-floppy-disk me-1"></i> Create Statistic
            </button>
    ...
    <div class="col-lg-4">
      <div class="ds-card p-4">
        ...
        <div class="text-center p-3 rounded" style="background: var(--ds-soft);">
          <div class="stat-item">
            <div class="stat-number" style="color: #f39c12; font-size: 3rem; font-weight: 700;">
              <span id="previewNumber">0</span>
            </div>
            <div class="stat-label" style="font-size: 1.2rem; margin-top: 10px;">
              <span id="previewLabel">Lives Impacted</span>
            </div>
          </div>
        </div>

...
<head>
  ...
  <style>
    ...
    .ds-layout{
      ...
      /* contain:layout style; - REMOVED: This blocks modals from being clickable! */
    }
    
    /* When modal is open, ensure no containment interferes */
    body.modal-open .ds-layout,
    body.modal-open .ds-sidebar,
    body.modal-open .ds-content,
    body.modal-open .ds-topbar {
  ...
  <!-- CRITICAL: Global Modal Fix - Ensure ALL modals are always clickable -->
  <style>
    /* Force correct z-index for ALL modals and backdrops */
    .modal-backdrop {
    ...
    /* All modal interactive elements must work */
    .modal-content *,
    .modal-header *,
    .modal-body *,
    .modal-footer *,
    ...
    /* Remove layout containment when modal is open */
    body.modal-open * {
      contain: none !important;
    }
  </style>
    ...
    <aside class="ds-sidebar">
      ...
      <div class="ds-nav-container">
        <nav class="ds-nav">
          ...
          <a href="{{ route('dashboard.gallery.index') }}" class="{{ request()->routeIs('dashboard.gallery.*') ? 'active' : '' }}">
            <span class="ds-icon fa-solid fa-images"></span>
            <span class="ds-label">Gallery Photos</span>
          </a>
      ...
      @endif
          ...
          <a href="{{ route('dashboard.vacancies.index') }}" class="{{ request()->routeIs('dashboard.vacancies.*') ? 'active' : '' }}">
            <span class="ds-icon fa-solid fa-briefcase"></span>
            <span class="ds-label">Vacancies</span>
          </a>
          <hr class="text-white-50">

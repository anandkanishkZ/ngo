            ...
            <div class="col-lg-8">
                ...
                <div class="project-content" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="gallery-grid">
                        ...
                        <div class="gallery-item" onclick="openLightbox('{{ asset('uploads/projects/' . basename($image)) }}')">
                            <img src="{{ asset('uploads/projects/' . basename($image)) }}" alt="Project Image" loading="lazy">
                        </div>
                        @endforeach
                    </div>
                </div>

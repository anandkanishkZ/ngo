...
@section('content')
            ...
            <div class="row align-items-center mb-5">
                ...
                <div class="col-lg-6" data-aos="fade-left">
                    <div class="about-image-wrapper position-relative" style="overflow: hidden; border-radius: 12px; background: #f0f0f0; min-height: 400px; display: flex; align-items: center; justify-content: center;">
                        <img src="{{ asset('images/about-us.jpg') }}" alt="JIDS Nepal Community Work" class="img-fluid" style="width: 100%; height: 100%; object-fit: cover; border-radius: 12px; box-shadow: 0 10px 30px rgba(0,0,0,0.15);" loading="eager" decoding="async">
    ...
    <!-- Organogram Section -->
    <section class="organogram-section section-padding">
        <div class="container">
            <!-- Section Header -->
            <div class="text-center mb-5" data-aos="fade-up">
            ...
            <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="100">
                <div class="col-lg-10">
                    <div class="organogram-wrapper">
                        <img src="{{ asset('images/organization-chart.jpg') }}" 
                             alt="JIDS Nepal Organizational Chart" 
                             class="img-fluid organogram-img"
                             loading="lazy">
                    </div>
                </div>
            </div>

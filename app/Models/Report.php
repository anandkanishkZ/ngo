...
class Report extends Model
{
    ...
    {
        if ($this->cover_image) {
            return Storage::url('reports/covers/' . $this->cover_image);
        }
        
        // Default cover images based on type
        $defaults = [
            'annual' => 'images/reports/default-annual.jpg',
            'quarterly' => 'images/reports/default-quarterly.jpg',
            'monthly' => 'images/reports/default-monthly.jpg',
            'project' => 'images/reports/default-project.jpg',
            'financial' => 'images/reports/default-financial.jpg',
            'impact' => 'images/reports/default-impact.jpg'
        ];
        
        return asset($defaults[$this->type] ?? 'images/reports/default-report.jpg');
    }

    public function getPdfUrlAttribute(): ?string
    {
        if ($this->pdf_file) {
            return Storage::url('reports/pdfs/' . $this->pdf_file);
        }

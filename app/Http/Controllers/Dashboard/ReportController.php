...
class ReportController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('cover_image')) {
            ...
            $coverImage->storeAs('public/reports/covers', $coverImageName);
        ...
        if ($request->hasFile('pdf_file')) {
            ...
            $pdfFile->storeAs('public/reports/pdfs', $pdfFileName);
    ...
    public function update(Request $request, Report $report)
    {
        ...
        if ($request->filled('remove_cover_image') && $request->remove_cover_image == '1') {
            if ($report->cover_image) {
                Storage::delete('public/reports/covers/' . $report->cover_image);
        ...
        if ($request->filled('remove_pdf_file') && $request->remove_pdf_file == '1') {
            if ($report->pdf_file) {
                Storage::delete('public/reports/pdfs/' . $report->pdf_file);
